...
function ApiCallingPostsRes() {
  ...
  function dataView() {
    ...
    axios.get('https://jsonplaceholder.typicode.com/posts?_limit=10') //limit display only 10 records
      .then((res) => {
  ...
  return (
    <>
      <Container maxWidth="lg">
        <Box>
          <Typography variant='h5' align='center' sx={{ textDecoration: 'underline', mt: 4, fontWeight: 'bold' }}>JSONPlaceholder comes with Posts resources</Typography>
...
export default ApiCallingPostsRes

...
function ApiCallingGetStudent() {
    ...
    function dataView() {
        axios.get('https://generateapi.techsnack.online/api/student',{
            headers:{
                Authorization: token
            }
        })
                            ...
                            <TableBody>
                                {list.map((i, index) => (
                                    ...
                                    >
                                        ...
                                        <TableCell align='center'>{i.firstname}</TableCell>
...
export default ApiCallingGetStudent

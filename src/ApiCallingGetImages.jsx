...
function ApiCallingGetImages() {
   ...
   function dataView(){
     axios.get('https://generateapi.techsnack.online/api/image',{
        headers:{
            Authorization: token
        }
     })
                            ...
                            <TableBody>
                                {list.map((i, index) => (
                                    ...
                                    >
                                        ...
                                        <TableCell align='center'>{i.title}</TableCell>
                                        <TableCell align='center'>
                                            <img src={i.url} alt="" width={40} height={40}/>
                                        </TableCell>
                                    </TableRow>
                                ))}
                            </TableBody>
...
export default ApiCallingGetImages
